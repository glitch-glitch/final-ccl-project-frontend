        ...
        <div class="col-12">
            <div class="card">
                ...
                <form @submit="submitForm" enctype="multipart/form-data" method="post">
                    ...
                    <div class="field p-fluid">
                        <label for="file_input1">Select File</label><br>
                    ...
                    <div class="field p-fluid">
                        ...
                        <Datepicker id="start_date_time1" v-model="v$.assignment.start_date_time.$model" :format="'d-M-Y HH:ii'"/>
                    </div>
                    <div class="field p-fluid">
                        <label for="end_date_time1">Assignment End Date Time</label>
                        <Datepicker id="end_date_time1" v-model="v$.assignment.end_date_time.$model" :format="'d-M-Y HH:ii'"/>
                    </div>
                    <div class="field p-fluid">
...
export default {
    ...
    methods: {
        ...
        submitForm(e) {
            ...
            data.append('name', this.assignment.name);
            data.append('description', this.assignment.description);
            data.append('rubric', this.assignment.rubric);
            data.append('start_date_time', this.assignment.start_date_time);
            data.append('end_date_time', this.assignment.end_date_time);
            data.append('total_marks', this.assignment.total_marks);
            data.append('allow_late_submision', this.assignment.allow_late_submision);
            data.append('more_info_link', this.assignment.more_info_link);
            data.append('visibility', this.assignment.visibility);
            data.append('add_for_all_classrooms', this.assignment.add_for_all_classrooms);
            data.append('subject_id', this.assignment.subject_id);
            data.append('classroom_id', this.assignment.classroom_id);
            data.append('batch_id', this.assignment.batch_id);
            axios.post(`${process.env.VUE_APP_API_URL}/assignments/store`, data, config)
            .then(data => {
                let response = data.data;
